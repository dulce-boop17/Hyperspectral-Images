...
print("\nImage dimensions:") 
print("Rows:", rows) print("Columns:", cols)  
...
# Plot the average of the spectra of the selected pixels 
plt.figure() 
plt.plot(wavelengths, average_spectrum, label=' Average of Selected Pixels'.) 
